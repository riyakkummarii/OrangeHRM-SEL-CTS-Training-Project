...
public class TC_010 extends DemoprojWrappers{
	@Test(dataProvider="fetchData")

	public void tc10(String url,String First_Name,String Last_Name,String	Email	,String Job_Title	,String Company,String	Phone_Number)
  ...
  String data="India";
	new OrangeHRM_HomePage()
		...
		.Captcha()
		.Submit()
		.assertCheckCountryDropdown(data)
