...
public class TC_004 extends DemoprojWrappers{
	@Test(dataProvider="fetchData")

	public void tc4(String url,String First_Name,String Last_Name,String	Email	,String Job_Title	,String Company,String	Phone_Number)
	...
	new OrangeHRM_HomePage()
	    .clickFree30DayTrial()
		.enterURL(url)
		.enterLastName("KumariHemsworthRiyaxm")
